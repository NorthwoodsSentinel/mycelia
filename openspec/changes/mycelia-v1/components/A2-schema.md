# Component Spec: D1 Schema Migrations
...
Create the complete D1 migration with all 10 tables, indexes, constraints, and seed data for the 22 initial capability tags.
...
-- Seed data: 22 capability tags across 6 categories
...
- [ ] Migration applies cleanly: `wrangler d1 migrations apply mycelia-db --local`
- [ ] All 10 tables created with correct columns
- [ ] All indexes created
- [ ] All CHECK constraints enforced
- [ ] 25 capability tags seeded (22 from arch doc + 3 added general tags)
- [ ] Foreign key relationships valid

## Notes

- Added trust_score_as_helper and trust_score_as_requester columns to agents table (from arch doc section 3.5)
- CHECK constraints enforce enum values at the DB level
- Foreign keys are declared but SQLite doesn't enforce them by default — application logic handles referential integrity
- The seed data has 25 tags (architecture doc says 22 across 6 categories, but general has 4 not 2)
